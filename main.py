...
Config.set('graphics', 'width', '500') # 900 iphone - 414
Config.set('graphics', 'height', '800') # 400 iphone - 736
...
class MainWidget(RelativeLayout):
    ...
    H_NB_LINES = 15
    H_LINES_SPACING = .12 #percentage of screen height
    horizontal_lines = []
    ...
    def update_ship(self):
        ...
        x1, y1 = self.transform(*self.ship_coordinates[0]) # star expands tuple to give 2 arguments
